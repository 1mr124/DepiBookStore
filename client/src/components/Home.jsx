...
const HomePage = () => {
  ...
  return (
    // <div className="d-flex flex-column full-height container-fluid" style={{ backgroundColor:"#eee"}}>
    <div className="d-flex flex-column container-fluid con" style={{ backgroundColor: "#eee" }}>
